//#region node_modules/.nitro/vite/services/ssr/assets/modules.server-BVLJfUBY.js
...
function getCategoryUrl(moduleId, categoryIndex) {
...
//#endregion
export { getCategoryUrl, getPublicModules };
