...
//#region node_modules/.nitro/vite/services/ssr/assets/auth-D8kQEmHf.js
...
function getAccessEmail() {
	...
	for (const part of document.cookie.split(";")) {
		...
		if (idx === -1) continue;
		if (part.slice(0, idx).trim() === EMAIL_COOKIE) return decodeURIComponent(part.slice(idx + 1).trim());
	}
	return null;
}
//#endregion
export { getAccessEmail as n, MembersHeader as t };
